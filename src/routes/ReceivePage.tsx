...
import { ViewOnEtherscanButton } from "../components/button/ViewOnEtherscanButton"
...
const ReceivePage = () => {
    ...
    return (
        <PopupLayout
            header={
                <PopupHeader title="Receive Funds" close="/accounts/menu" />
            }
        >
            ...
            <div className="flex flex-col items-center justify-center w-full mt-6 px-6">
                ...
                <ViewOnEtherscanButton type="address" hash={accountAddress} />
            </div>
        </PopupLayout>
    )
}
